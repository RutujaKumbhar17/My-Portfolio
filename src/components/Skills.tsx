...
const Skills: React.FC = () => {
  ...
  return (
    <section 
      id="skills" 
      className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-blue-100 via-indigo-50 to-slate-100 dark:from-slate-800 dark:via-blue-900 dark:to-slate-700"
      ref={ref}
    >
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div>
                    ...
                    <div className="flex justify-between items-center mb-2 sm:mb-3">
                      <span className="text-sm sm:text-base text-gray-800 dark:text-gray-200 font-medium">18+ Questions</span>
                      <span className="text-sm sm:text-base text-blue-600 dark:text-blue-400 font-bold">80%</span>
                    </div>
                  ...
                  <a
                    href="https://leetcode.com/u/rutujakumbhar17/"
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              >
                ...
                <ul className="list-disc list-inside space-y-2 sm:space-y-3 text-gray-800 dark:text-gray-300 text-xs sm:text-sm">
                  <li>
                   ...
                   <li>
                    <span className="font-semibold">Azure Data Fundamentals </span> – Microsoft
                   </li>
                </ul>
                <a
                  href="https://www.linkedin.com/in/rutuja-kumbhar-a7311b2a9/details/certifications/"
                  target="_blank"
                  rel="noopener noreferrer"
